# Day 48 project - Automated Cookie Clicker Game Bot.
...
# Opening Cookie Clicker game webpage.
driver.get("http://orteil.dashnet.org/experiments/cookie/")

# Getting cookie element to click on.
...
while True:
    ...
    if time.time() > timeout:
        ...
        # Adding another 5 seconds until the next check.
        timeout = time.time() + 5
