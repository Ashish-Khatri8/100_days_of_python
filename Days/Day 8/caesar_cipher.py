...
# Import logo from cipher_art.py and print it.
...
def caesar_cipher(input_text, shift_no, cipher_direction):
    output_text = ""
    ...
    for letter in input_text:
        ...
        if letter in characters:
            ...
            if position + shift_no > 94:
                new_position = position + shift_no - 95
            elif position + shift_no < 0:
                new_position = position + shift_no + 95
            else:
                new_position = position + shift_no
            
            # Add the character at new_position to the output_text.
